...
datagen.js: generates random data for my-yelp database defined by the schema in my_yelp.sql.

To generate 100 restaurants:

node --max-old-space-size=2048 datagen.js restaurant 100000 |psql my_yelp

To generate 100 reviewers:

node --max-old-space-size=2048 datagen.js reviewer 100000 |psql my_yelp

To generate 100 reviews, where 200 is the current max ID for restaurants and 300 is the current max ID for reviewers:

node --max-old-space-size=2048 datagen.js review 100000 100000 100000 |psql my_yelp
